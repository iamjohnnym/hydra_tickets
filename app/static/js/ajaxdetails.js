                ...
                self.ajax(self.callbackDetailsURI, 'GET').done(function(data) {
                    ...
                    for (var i = 0; i < data.details.length; i++) {
                        ...
                        self.callback.push({
                            ...
                            platform: ko.observable(data.platform.capitalize()),
                            platform_fa: ko.observable(platform_fa),
                            uri: ko.observable('/callbacks/'+data.id),
                            ticket_url: ko.observable(
                                'https://to.remove/tickets/'+data.ticket),
                            ddi_url: ko.observable(
                                'https://customer.account/customer/'+data.ddi),
                            ...
                            message_title: ko.observable("Message Details - "+data.details[i].status.capitalize()+" at "+updated+" by "+data.details[i].user_name),
                            private_title: ko.observable("Private Note - "+data.details[i].status.capitalize()+" at "+updated+" by "+data.details[i].user_name),
